...
ln -fnsv {$XDG_CONFIG_HOME/,~/.}profile && echo "Bootstrapped profile"
[[ $(uname) == "Darwin" ]] && ln -fnsv {$XDG_CONFIG_HOME/,~/Library/LaunchAgents/}org.freedesktop.xdg.plist && echo "Bootstrapped launchd"
